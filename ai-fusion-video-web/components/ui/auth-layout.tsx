      ...
      <div className="relative z-10 flex flex-col flex-1">
        ...
        <div className="absolute top-6 left-6 z-20 flex items-center gap-3">
          ...
          <div className="flex items-center text-[1.72rem] font-semibold tracking-[0.02em]">
            <span className="text-transparent bg-[linear-gradient(96deg,#7adcf2_0%,#2EC7D5_38%,#2488C8_100%)] bg-clip-text drop-shadow-[0_0_10px_rgba(46,199,213,0.18)] font-bold">
              AI
            </span>
